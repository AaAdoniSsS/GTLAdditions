...
> After enabling, each processed recipe requires consumption of recipe parallel number / 108 of <ItemLink id="kubejs:quantum_anomaly" /> and recipe parallel number / 623 of <ItemLink id="kubejs:hypercube" /> \
