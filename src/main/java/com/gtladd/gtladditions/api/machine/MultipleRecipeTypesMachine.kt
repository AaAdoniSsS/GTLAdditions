...
open class MultipleRecipeTypesMachine(holder: IMachineBlockEntity) :
    WorkableElectricMultiblockMachine(holder), IMultipleRecipeTypeMachine {

    override fun getRecipeLogic() = super.getRecipeLogic() as MultiRecipeTypesLogic

    override fun createRecipeLogic(vararg args: Any) = MultiRecipeTypesLogic(this)
